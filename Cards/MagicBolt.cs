...
internal sealed class MagicBoltCard : Card, IDemoCard
{
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("MagicBolt", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "MagicBolt", "name"]).Localize
        });
