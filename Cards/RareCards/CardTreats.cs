...
internal sealed class CardTreats : Card, IDemoCard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("Treats", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "Treats", "name"]).Localize
        });
    }
