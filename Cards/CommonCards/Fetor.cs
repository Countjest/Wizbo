...
internal sealed class CardFetor : Card, IDemoCard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("Fetor", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "name", "Fetor"]).Localize
        });
    }
