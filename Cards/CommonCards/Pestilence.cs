...
internal sealed class CardPestilence : Card, IDemoCard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("Pestilence", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "Pestilence", "name"]).Localize
        });
    }
    public override CardData GetData(State state)
    {
        CardData data = new CardData()
        {
            ...
            temporary = true,
            exhaust = true,
            description = ModEntry.Instance.Localizations.Localize(["card", "Pestilence", "description", upgrade.ToString()])
