...
internal sealed class CardToxico : Card, IDemoCard
{
    ...
    public static void Register(IModHelper helper)
    {
        helper.Content.Cards.RegisterCard("Toxico", new()
        {
            ...
            Name = ModEntry.Instance.AnyLocalizations.Bind(["card", "Toxico", "name"]).Localize
        });
    }
    public override CardData GetData(State state)
    {
        CardData data = new CardData()
        {
            ...
            temporary = true,
            exhaust = true,
            description = ModEntry.Instance.Localizations.Localize(["card", "Toxico", "description", upgrade.ToString()])
